...
const images = [
	...
	{ src: '/images/brands/image 12.webp' },
	...
	{ src: '/images/brands/image 18.webp' },
...
function NextArrow(props: any) {
	...
	return (
		<div
			className={`${className} bg-[#EDF0F9] rounded-full p-[20px] xl:p-[3vh] hover:bg-[#EDF0F9] shadow-md`}
			style={{
				...style,
				display: 'flex',
				alignItems: 'center',
...
function Carousel() {
	...
	return (
		<div className='mx-[20px] slider-container'>
			<Slider {...settings}>
