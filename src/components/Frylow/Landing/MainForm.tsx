...
import Above60Modal from './modals/Above60Modal'
import Above100Modal from './modals/Above100Modal'
...
const MainForm: React.FC<MainFormProps> = ({
	...
	const handleSubmit = async (
		...
		if (Object.keys(errors).length > 0) {
			...
			if (!hasShownToast) {
				toast({
					...
					containerStyle: {marginBottom: ['100px', null, '25px']}
				})
		...
		const friersNum = values.fryerAmountOneLocation
		const freq = values.oilChangeAmountPW
	...
	return (
		<div className=' w-full rounded-lg drop-shadow-md px-[20px] lg:px-0'>
			<Formik
				initialValues={{
					firstName: '',
					lastName: '',
					...
					<Form>
						<div className='flex justify-between text-center md:text-start w-full bg-[#EDF0F9] pb-0 lg:pb-0  p-[0.5vh] lg:px-[3vh]  rounded-t-lg xl:mt-0'>
							...
							<Above100Modal
								...
								setFieldValue={setFieldValue}
							/>
							<div className='w-full md:w-fit mt-[1vh]'>
								<h2 className='lg:text-[2.3vh] mb-[0.5vh] font-[500] '>
									<b>Calculate</b> your Restaurant Fry-Oil expense
								</h2>
								<h2 className='lg:text-[2.3vh] mb-[0.5vh] '>
									<b className='text-[#416CF6]'>FREE</b> Cost Savings Estimate
								</h2>
								<i>
									<p className='lg:text-[2.3vh] text-[#416CF6]'>
										Qualify for a <b>no</b> obligation, <b>no</b> cost trial.
									</p>
								</i>
								<p className='text-[1.4vh] text-start mt-[0.5vh]'>
						...
						<div className=' bg-[#EDF0F9] p-[1vh] lg:px-[3vh] rounded-b-lg lg:h-[58vh] flex flex-col justify-between'>
							<div className='flex gap-[0.5vh] md:gap-[3vh] mb-[0.5vh] flex-col lg:flex-row'>
								<div className='lg:w-1/2'>
									...
									<Field
										...
										className={`w-full rounded-lg text-sm md:text-2vh md:text-[1.7vh] p-[0.4vh] md:p-[0.7vh] h-[3vh] md:h-[4vh] border ${
											errors.firstName ? 'border-red-500' : 'border-[#416CF6]'
								...
								<div className='lg:w-1/2'>
									...
									<Field
										...
										name='lastName'
										className={`w-full rounded-lg text-sm md:text-2vh md:text-[1.7vh] p-[0.4vh] md:p-[0.7vh] h-[3vh] md:h-[4vh] border ${
											errors.lastName ? 'border-red-500' : 'border-[#416CF6]'
							...
							<div className='flex items-center mb-[0.5vh] justify-between flex-col-reverse lg:flex-row gap-[0.5vh] md:gap-[3vh]'>
								<div className='w-full lg:w-1/2 lg:mx-auto mt-[0.5vh] lg:my-2'>
									<label
										htmlFor='code'
										className='text-[14px] md:text-2vh md:text-2vh md:text-[1.7vh]'
									>
									...
									<Field name='isChainFranchise'>
										{({ field }: { field: any }) => (
											<div className='w-full  lg:text-start flex flex-col'>
												<p className='text-sm md:text-2vh md:text-[1.7vh] leading-[108%] font-[700] mt-[0.5vh] md:my-[1vh] lg:text-center'>
