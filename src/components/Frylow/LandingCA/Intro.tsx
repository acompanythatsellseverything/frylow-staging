import {
	canadianHeaderReviews,
	canadianMobileHeaderReviews,
} from '../../../data/canadianHeaderReviews'
	...
	return (
		<div className='flex h-full hustify-between  w-full flex-col'>
			...
			<div className='flex gap-[2vh] mt-[1vh] flex-col xl:flex-row hidden xl:flex'>
				{canadianHeaderReviews.map((item, index) => (
					<>
			...
			<div className='flex gap-6  flex-col xl:flex-row py-[10px] px-[20px] xl:hidden'>
				{canadianMobileHeaderReviews.map((item, index) => (
	...
	return (
		<div className='w-full flex flex-col 2xl:h-[83vh] w-1/2'>
			...
			<div className='flex flex-col '>
				...
				<i className='text-[#416CF6] text-center w-full text-2xl lg:text-[2.8vh] font-medium my-4 md:my-[2vh]'>
